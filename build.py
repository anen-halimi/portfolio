...
for key, filename in [('source', 'rail-source.png'), ('style', 'rail-style.png'), ('incrustation', 'incrustation-result.png'), ('incrustationSource', 'incrustation-source.png'), ('incrustationFinal', 'incrustation-final.png')]:
