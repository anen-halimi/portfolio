...
for key, filename in [('source', 'rail-source.png'), ('style', 'rail-style.png'), ('incrustationSource', 'incrustation-source.png'), ('incrustationFinal', 'incrustation-final.png'), ('vaeNatEmpty', 'vae-nat-empty.png'), ('vaeNatOccupied', 'vae-nat-occupied.png')]:
